...
def bootstrapping(ds, ds_roll,variable,n_samples,intensity_range,log_fit=False,cut_off=60,keep_raw_values=False):
    ...
    fit_data={var: pd.DataFrame(index=np.arange(n_samples), columns=['R2','params']) for var in data_var_list}
