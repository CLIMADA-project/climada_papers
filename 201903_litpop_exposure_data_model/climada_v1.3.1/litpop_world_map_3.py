...
for res_target in res_targets:
    ...
    ax_exp_scatter = exposure_data.plot_scatter(pop_name=False, cmap='plasma', s=.01, shapes=False, \
                                                norm=LogNorm(vmin=100, vmax=0.1*exposure_data.value.max()))
    ...
    if save_plots:
        plt.savefig(os.path.join(RES_DIR, 'LitPop_pc_%iarcsec_%i_world_map_scatter001pt_lw.png' % (res_target, REF_YEAR)), \
                      dpi=300, facecolor='w', edgecolor='w', \
                      orientation='portrait', papertype=None, format='png', \
                      transparent=False, bbox_inches=None, pad_inches=0.1, \
                      frameon=None, metadata=None)
        plt.savefig(os.path.join(RES_DIR, 'LitPop_pc_%iarcsec_%i_world_map_scatter001pt_lw.pdf' % (res_target, REF_YEAR)), \
                      dpi=600, facecolor='w', edgecolor='w', \
                      orientation='portrait', papertype=None, format='pdf', \
                      transparent=False, bbox_inches=None, pad_inches=0.1, \
                          frameon=None, metadata=None)