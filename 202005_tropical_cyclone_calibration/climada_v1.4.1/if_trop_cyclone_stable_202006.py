...
Define impact function and calibrated impact function set for tropical cyclones.

@author: Gabriela Aznar-Siguan, Samuel Eberenz, David N. Bresch
"""
...
class IFSTropCyclone(ImpactFuncSet):
    ...
    def set_calibrated_regional_IFs(self, calibration_approach='TDR', q=.5, \
        ...
        if calibration_approach not in ['TDR', 'TDR1.0','TDR1.5', \
                                        'RMSF', 'EDR']:
