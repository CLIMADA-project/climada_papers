...
from constants import CNTRIES, CNTRIES_ISO, RESOL, YEAR, GDP_NLD_ISL, INC_GRP, \
GDP, POLY_VAL, C_TRACKS_NAME
...
def calc_tracks(data_dir, pool):
    ...
    try:
        ...
        sel_ibtracs.read_ibtracs_netcdf(provider='usa', storm_id=C_TRACKS_NAME,
                                        correct_pres=True)
