    ...
    for j in range(4):
        ...
        if j<3:
            ...
            if j ==0:
                ...
                f3_ax1.plot(DATA_regionFull['Year'], np.log10(DATA_regionFull['Norm_Imp2010_2y_offset']), label='$D_{2010}$', color='seagreen', linewidth = 1.)
        ...
        colour_code = ['seagreen','gold','#d73027','#8856a7','seagreen','#fee090','#d73027','#8856a7','','#fee090','#d73027','#8856a7']
...
plt.savefig('/home/insauer/projects/NC_Submission/Data/Figures/Supplement/SI6_Figure_2010.svg',bbox_inches = 'tight', format = 'svg')
