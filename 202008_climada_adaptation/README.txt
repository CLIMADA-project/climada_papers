...
Execution first time: execute script_risk.py from your Python console. It will take approximately 3 hours to compute 
all the risk metrics of the region and save the results in a "results_eca" folder.
The IBTRACS data used in this publication is contained in IBTrACS.ALL.v04r00.nc. 
You might use this in your CLIMADA execution to obtain exactly the same results as in the publication.
