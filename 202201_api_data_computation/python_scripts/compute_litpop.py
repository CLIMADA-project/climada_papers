...
data_dir = os.path.join(OUT_DATA_DIR, 'litpop', 'assets')
exposures_list = []
for country in countries:
...
exposures_concat = Exposures()
exposures_concat = exposures_concat.concat(exposures_list)
exposures_concat.tag = 'Global LitPop Exposure at 150 as, year: 2018, financial mode: pc, exp: (3, 0), admin1_calc: False'
exposures_concat.write_hdf5(os.path.join(data_dir, 'LitPop_assets_150arcsec.hdf5'))
